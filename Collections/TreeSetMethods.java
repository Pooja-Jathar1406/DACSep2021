...
class TreeSetMethods{
	...
	//*** Display method
	static void Display(SortedSet<Student> set){
	...
	public static void main(String args []){
		...
		//we are using TreeSet which implements SortedSet so all the elements will be sorted
		SortedSet<Student> set1 = new TreeSet<Student>();      //SortedSetForUserDefinedObjects
		Student s1 = new Student(1, "Rohit" , 55.0,20); 
		set1.add(s1); 
		...
		SortedSet<Student> set2 = new TreeSet<Student>();  
		set2.add(new Student(5, "Priya" , 65.0,23)); 
		set2.add(new Student(6, "Nita" , 47.2,14)); 
